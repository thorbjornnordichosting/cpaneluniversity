            ...
            <div className="lg:sticky lg:top-6 lg:self-start">
              {showExplanation && (
                <div className="animate-fade-in space-y-6">
                  ...
                  <div className="rounded-3xl p-8 max-h-[520px] overflow-y-auto border border-white/20 shadow-2xl shadow-orange-500/40" style={{background: 'rgba(255, 255, 255, 0.02)', backdropFilter: 'blur(100px) saturate(250%) brightness(120%) contrast(110%)', WebkitBackdropFilter: 'blur(100px) saturate(250%) brightness(120%) contrast(110%)', boxShadow: '0 8px 32px 0 rgba(255, 140, 0, 0.37), inset 0 0 20px rgba(255, 255, 255, 0.05)'}}>
                    <h3 className="text-xl font-bold text-white mb-4 flex items-center sticky top-0 pb-4 -mx-8 px-8 pt-2 z-10 rounded-t-3xl border-b border-white/20" style={{background: 'rgba(255, 255, 255, 0.08)', backdropFilter: 'blur(60px) saturate(200%) brightness(110%)', WebkitBackdropFilter: 'blur(60px) saturate(200%) brightness(110%)', boxShadow: '0 4px 16px rgba(255, 140, 0, 0.2)'}}>
                      <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                      Verkligt Exempel
                    </h3>
                    <div className="text-orange-50 font-medium whitespace-pre-wrap" style={{textShadow: '0 1px 2px rgba(0,0,0,0.3)'}}>
                      {question.example}
                    </div>
                  </div>
