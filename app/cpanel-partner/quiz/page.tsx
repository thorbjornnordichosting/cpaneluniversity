            ...
            <div className="lg:sticky lg:top-6 lg:self-start">
              {showExplanation && (
                <div className="animate-fade-in space-y-6">
                  ...
                  <div className="rounded-3xl p-8 border-2 border-purple-400/50 shadow-2xl bg-gradient-to-br from-purple-900/95 via-violet-800/95 to-purple-900/95" style={{boxShadow: '0 10px 40px rgba(139, 92, 246, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)'}}>
                    <h3 className="text-xl font-bold text-white mb-6 flex items-center pb-4 border-b-2 border-purple-300/40" style={{boxShadow: '0 2px 10px rgba(139, 92, 246, 0.3)'}}>
