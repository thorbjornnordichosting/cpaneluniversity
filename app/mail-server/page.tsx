    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900">
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
        <div className="max-w-4xl w-full">
          <div className="bg-white/5 backdrop-blur-3xl rounded-3xl p-12 border border-white/10 shadow-2xl shadow-purple-500/10 text-center">
            <div className="mb-8">
              <svg className="w-24 h-24 mx-auto text-purple-400 mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xl text-orange-100 mb-8 leading-relaxed">
              Lär dig konfigurera och hantera mail servrar & WHM för att bli en certifierad cPanel-partner!
            </p>

            <Link
              href="/mail-server/quiz"
              className="inline-block mb-12 group relative px-16 py-8 bg-gradient-to-r from-purple-600 via-purple-500 to-pink-500 rounded-3xl font-bold text-white text-3xl md:text-4xl shadow-2xl hover:shadow-purple-500/50 transform hover:scale-105 transition-all duration-300"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-orange-600 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
            </Link>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center w-full max-w-3xl mx-auto">
              <Link
                href="/mail-server/quiz"
                className="w-full md:w-auto text-center px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-500 rounded-2xl font-bold text-white hover:shadow-lg hover:scale-105 transition-all shadow-xl"
              >
                Starta cPanel Quiz →
              </Link>
              <Link
