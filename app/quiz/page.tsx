            ...
            <div className="lg:sticky lg:top-6 lg:self-start">
              {showExplanation && (
                <div className="animate-fade-in space-y-6">
                  ...
                  <div className="rounded-3xl p-8 max-h-[520px] overflow-y-auto border border-white/10 shadow-2xl shadow-purple-500/30" style={{background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(60px) saturate(200%) brightness(110%)', WebkitBackdropFilter: 'blur(60px) saturate(200%) brightness(110%)'}}>
